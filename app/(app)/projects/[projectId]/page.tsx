    ...
    <main className="p-6 max-w-3xl mx-auto">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">
          {project.name} <span className="opacity-70 text-base">({project.key})</span>
        </h1>
      ...
      <div className="mt-8 border rounded p-4">
        ...
        <div className="mt-4 flex gap-3">
          <Link className="border rounded px-3 py-1" href={`/projects/${project.id}/issues`}>
            Issues
          </Link>
          ...
          <Link className="border rounded px-3 py-1" href={`/projects/${project.id}/members`}>
            Members
          </Link>
        ...
        <ul className="list-disc pl-5 mt-4 text-sm">
          <li>{currentUserRole === "ADMIN" ? "Create Issues" : "View and track issues"}</li>
